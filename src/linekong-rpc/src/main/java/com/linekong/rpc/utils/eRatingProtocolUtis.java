...
public class eRatingProtocolUtis {

	/**
	 * 计算erating协议的checksum值 
	 * @param byte [] data
	 * @param int len
	 * @return
	 */
	...
	private static final int crc_table[] = { 0x0000, 0x1189, 0x2312, 0x329B, 0x4624, 0x57AD, 0x6536, 0x74BF, 0x8C48,
